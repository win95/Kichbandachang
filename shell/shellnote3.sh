...
sleep 2
sudo iwconfig $name1 mode ad-hoc	essid Adhoc-wifi1 ap A2:BD:B6:6C:83:68 channel 3
...
sleep 2
sudo ifconfig $name1 10.42.43.3
sudo ifconfig $name2 10.42.43.31
sleep 2 
...
sudo ifconfig bat0 192.168.0.3/24
